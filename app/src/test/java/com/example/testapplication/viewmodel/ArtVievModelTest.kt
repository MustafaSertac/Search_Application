...
import com.example.testapplication.repo.FakeArtRepository
import com.example.testapplication.util.Status
...
class ArtViewModelTest {
    ...
    @Before
    fun setup() {
        viewModel = ArtViewModel(FakeArtRepository.FakeArtRepository())
    }
